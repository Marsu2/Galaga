...
public class Game {
    ...
    public void draw() {
        ...
        // Position du pixel de départ en se basant sur le point de départ
        double px = 0 ;
        double py = 0.1;
        // Position du pixel d'arrivé en se basant sur le point de départ
        double pxEnd = 0 ;
        double pyEnd = 0.1;

        // On dessine kle pixel en fonction d@@e la position
