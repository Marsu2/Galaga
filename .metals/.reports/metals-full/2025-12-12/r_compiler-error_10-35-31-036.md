...
public class Game {
    ...
    public void draw() {
        ...
        //on dessine score/Highscore
        StdDraw.setPenColor(StdDraw.RED);
        StdDraw.text(0.15,0.97,"SCO@@RE");
        StdDraw.text(0.5,0.97,"HIGHSCORE");
        
        // on dessine le score/Highscore en dessous du dessin de score/Highscore
        StdDraw.setPenColor(StdDraw.WHITE);
    ...
    private void update() {
        ...
        player.checkMissileHits(missilesEnemies);
        for (Enemy e : enemies) e.checkMissileHits(missilesPlayers); 
        score.saveHighscore();
    }
        /**
