...
public class Bee extends Enemy {
    ...
    public Bee(double positionx, double positiony, double size, int score, double spee, int shootCooldown) {
        super(positionx, positiony, size, score, sp@@eed, shootCooldown);
    }
