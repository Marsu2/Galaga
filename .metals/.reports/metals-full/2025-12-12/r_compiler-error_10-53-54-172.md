...
public abstract class Enemy extends Entity {
    ...
    public Enemy(double positionx, double positiony, double size, int score, double speed) {
    ...
    public boolean canShoot() {
        if (coolDownShootMax == 0) {
            coolDownShootMax = (int) game.ge@@tLevelManager().getCurrentLevel().getShootCooldown() / 100;
