...
public class Moth extends Enemy {
    ...
    public Moth(double positionx, double positiony, double size, int score, double speed, double shootCooldown) {
        super(positionx, positiony, size, score, speed, shoo@@tCooldown);
    }
