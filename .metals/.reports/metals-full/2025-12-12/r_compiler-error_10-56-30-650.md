...
public abstract class Enemy extends Entity {
    ...
    public Enemy(double positionx, double positiony, double size, int score, double speed, double shootCooldown) {
        super(positi@@onx, positiony, size, 1, speed);
        this.score = score;
        this.coolDownShootMax = shootCooldown;
    ...
    public boolean canShoot() {
        if (coolDownShootMax == 0) {
            coolDownShootMax = (int) getLevelManager().getCurrentLevel().getShootCooldown() / 100;
