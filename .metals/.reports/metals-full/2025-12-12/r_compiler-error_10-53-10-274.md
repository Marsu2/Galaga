...
public class Game {
    ...
    public void launch() {
        ...
        while (isGameRunning()) {
            StdDraw.clear(StdDr@@aw.BLACK); // On efface tous ce qu'il y a sur l'interface
    ...
    public void draw() {
        ...
        manager.drawSpriteV2(0.9,0.05,0.001,"/ressources/sprites/level.spr");
    ...
    private void update() {
        ...
        for (Enemy e : enemies) {
            for (Missile missile : e.getMissiles()) {
