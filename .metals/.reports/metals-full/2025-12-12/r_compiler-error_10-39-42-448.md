...
public class Game {
    ...
    private void update() {
        ...
        for (Enemy enemy : enemies) {
            for (Missile missile : enemy.m) {
                
            }
        }
        player.checkHitBy(missilesEnemies);
        for (Enemy e : enemies) {
            e.checkHitBy(missilesPlayers);
        }
        score.saveHighscore();
    }
        /**
     * Détec@@te les collisions missile-ennemi et met à jour score/santé.
     */
